...
@endsection
    ...
    <span class="sub-title">Mes servives</span>
    ...
    <div class="container custom-container">
        ...
        <div class="row gx-0 services__active">
            <div class="col-xl-6 col-lg-6 col-md-6">
                <div class="services__item">
                    <div class="services__thumb">
                        <img src="{{ asset('path/to/your/image1.jpg') }}" alt="Déménagement Particuliers">
                    </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6">
                <div class="services__item">
                    <div class="services__thumb">
                        <img src="{{ asset('path/to/your/image2.jpg') }}" alt="Déménagement Entreprises">
                    </div>
                    <div class="services__content text-center">
